...
//
// Adapted from: toddmoore (http://answers.unity.com/answers/1296574/view.html)
...
public class ScreenRecorder : MonoBehaviour
{
    ...
    private string uniqueFilename(int width, int height)
    {
        ...
        var filename = string.Format("{0}/screen_{1}x{2}_.{3}", folder, width, height, format.ToString().ToLower());  // don't use counter
